...
export default function PaginaCatalogo() {
  ...
  const [userRole, setUserRole] = useState<'VISITOR' | 'STUDENT' | 'TEACHER'>('VISITOR')
  ...
  // Filtra livros conforme o papel do usuário
  const canSeeBook = (book: Book) => {
    if (book.accessLevel === 'PUBLIC') return true
    if (book.accessLevel === 'STUDENT_AND_TEACHER') return userRole === 'STUDENT' || userRole === 'TEACHER'
    if (book.accessLevel === 'TEACHER_ONLY') return userRole === 'TEACHER'
    return false
  }
